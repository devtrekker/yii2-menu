...
use devtrekker\menu\models\Model;
...
<div class="row">
    ...
    <div class="col-md-3"><?= $form->field($model, 'name')->textInput(['id' => 'create-name']); ?> </div>
    <div class="col-md-4"><?= $form->field($model, 'url')->textInput(['id' => 'create-url']); ?> </div>
    <div class="col-md-2">
        <?= $form->field($model, 'gr')->dropDownList($model->ListOfGroup())->label("Place");?> 
    </div>
    <div class="col-md-1">
        <br/>
        <?= Html::SubmitButton('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add', ['class' => 'btn btn-success btn-block']) ?>
    </div>
</div>
